...
OAUTH_PREFIX = '/SASLogon/oauth/token'
SEARCH_PREFIX = '/SASJobExecution'


class Client(BaseClient):
    def zencos_get_events(self, environment: str, since_datetime: str):
        query_params = {
            "_program": "/Projects/RLA/splunk",
            "_output_type": "json",
            "env": environment,
            "dttm": since_datetime
        }
